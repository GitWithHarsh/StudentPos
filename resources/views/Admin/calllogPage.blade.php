                ...
                <div class="page-header">
                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Journal d'appel</li>
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="card-title mainDashHead">Journal d'appel</h4>
                                ...
                                <div>
                                    ...
                                    <table class="table table-striped" id="student_list">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo date('d-m-y', strtotime($val->updated_at)) ?>
                                            </td>

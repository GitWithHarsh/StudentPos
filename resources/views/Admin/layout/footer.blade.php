 ...
 <footer class="footer">
     <div class="d-sm-flex justify-content-center justify-content-sm-between">
         <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">droits d'auteur @ studentpos.com 2023-2024</span>
         <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">
             Étudiante <a href="#" target="_blank">Student pos</a> from studentpos.com</span>
     </div>
 </footer>
 <!-- partial -->
 </div>
 ...
 <script src="{{asset('public/vendors/jvectormap/jquery-jvectormap.min.js')}}"></script>
 <script src="{{asset('public/vendors/jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
